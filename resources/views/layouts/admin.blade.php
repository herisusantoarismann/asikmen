    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Mental</div>
            </a>
            ...
            <li class="nav-item {{(Route::is('mental')) ? 'active' : ''}}">
                <a class="nav-link" href="{{ route('mental') }}">
                    <i class="fas fa-fw fa-solid fa-cogs"></i>
                    <span>{{ __('Mental Illness') }}</span>
                </a>
            </li>

            <li class="nav-item {{(Route::is('factor')) ? 'active' : ''}}">
                <a class="nav-link" href="{{ route('factor') }}">
            ...
            <li class="nav-item {{(Route::is('question')) ? 'active' : ''}}">
